...
The presentation slides contains a summary of the project as well as the result for each of the models. The files contains codes used for the project in three format: 
